...
const s: Record<string, CSSProperties> = {
  ...
  notFound: {
    ...
    color: petColors.gray400, fontFamily: 'BMJUA, sans-serif',
  },
  header: {
  ...
  avatarText: { fontSize: 18, fontWeight: 700, color: petColors.gray700 },
  authorInfo: {
  ...
  content: {
    ...
    color: petColors.gray700, fontFamily: 'BMHANNAPro, sans-serif',
    marginBottom: 16,
  },
  image: {
  ...
  actionCount: { fontSize: 14, color: petColors.gray500 },
