...
export function UserProfilePage() {
  ...
  const avatarColor = profile?.avatarColor ?? communityPosts.find(p => p.author.name === decodedName)?.author.avatarColor ?? petColors.gray200;
      ...
      <div style={s.profileSection}>
        <div style={s.avatarWrap}>
          <div style={{ ...s.avatarPlaceholder, backgroundColor: avatarColor }}>
            <svg width={48} height={48} viewBox="0 0 24 24" fill={petColors.gray500}>
