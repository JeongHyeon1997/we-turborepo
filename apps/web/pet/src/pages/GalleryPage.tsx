          ...
          <div style={s.photoModal} onClick={e => e.stopPropagation()}>
            ...
            <div style={s.photoHeader}>
              ...
              <button style={s.closeBtn} onClick={() => setSelected(null)}>
                <IoClose size={22} color={petColors.gray400} />
              </button>
            </div>
...
const s: Record<string, CSSProperties> = {
  ...
  emptyTitle: { margin: 0, fontSize: 17, fontFamily: 'BMJUA, sans-serif', color: petColors.gray700 },
  emptyDesc: { margin: 0, fontSize: 13, fontFamily: 'BMHANNAPro, sans-serif', color: petColors.gray400, textAlign: 'center', lineHeight: 1.7 },
  ...
  photoDate: { fontSize: 12, color: petColors.gray400, fontFamily: 'BMHANNAPro, sans-serif', display: 'block', marginBottom: 2 },
  photoTitle: { margin: 0, fontSize: 16, fontFamily: 'BMJUA, sans-serif', color: petColors.gray800 },
  closeBtn: {
    background: 'none',
    border: 'none',
    cursor: 'pointer',
  ...
  photoContent: { margin: 0, fontSize: 14, fontFamily: 'BMHANNAPro, sans-serif', color: petColors.gray600, lineHeight: 1.7 },
};
