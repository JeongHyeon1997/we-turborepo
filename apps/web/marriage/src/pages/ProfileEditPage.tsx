    ...
    <div style={s.page}>
      <div style={s.form}>
        ...
        <div style={s.avatarWrap}>
          <div style={s.avatar}>
            <svg width={52} height={52} viewBox="0 0 24 24" fill={marriageColors.gray400}>
...
const s: Record<string, CSSProperties> = {
  ...
  avatar: {
    ...
    backgroundColor: marriageColors.gray100,
  ...
  label: {
    ...
    color: marriageColors.gray600, fontFamily: 'BMJUA, sans-serif',
  },
  input: {
    padding: '12px 14px', borderRadius: 12,
    border: `1.5px solid ${ACCENT}55`,
    fontSize: 15, fontFamily: 'BMHANNAPro, sans-serif',
    color: marriageColors.gray800, outline: 'none',
    backgroundColor: marriageColors.white,
  },
  hint: {
    fontSize: 11, color: marriageColors.gray400,
    textAlign: 'right', fontFamily: 'BMHANNAPro, sans-serif',
  },
  readOnly: {
    padding: '12px 14px', borderRadius: 12,
    border: `1.5px solid ${marriageColors.gray100}`,
    fontSize: 15, fontFamily: 'BMHANNAPro, sans-serif',
    color: marriageColors.gray500,
    backgroundColor: marriageColors.gray50,
  },
  error: {
  ...
  saveBtn: {
    ...
    color: marriageColors.white, cursor: 'pointer',
