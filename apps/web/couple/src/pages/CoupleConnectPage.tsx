...
import { requestCoupleInvite } from '../api/couple.api';
    ...
    <div style={s.page}>
      ...
      <div style={s.section}>
        ...
        <div style={s.codeBox}>
          ...
          <button
            style={{ ...s.copyBtn, backgroundColor: copied ? coupleColors.primary200 : ACCENT + '22', color: copied ? coupleColors.gray700 : ACCENT }}
            onClick={handleCopy}
...
const s: Record<string, CSSProperties> = {
  ...
  heroTitle: { margin: 0, fontSize: 20, fontWeight: 700, fontFamily: 'BMJUA, sans-serif', color: coupleColors.gray900 },
  heroSub: { margin: 0, fontSize: 14, color: coupleColors.gray500, fontFamily: 'BMHANNAPro, sans-serif', textAlign: 'center' },
  section: { display: 'flex', flexDirection: 'column', gap: 8 },
  sectionLabel: { margin: 0, fontSize: 13, fontWeight: 700, color: coupleColors.gray600, fontFamily: 'BMJUA, sans-serif' },
  codeBox: { display: 'flex', alignItems: 'center', gap: 10, padding: '14px 16px', backgroundColor: coupleColors.white, borderRadius: 14, border: `1px solid ${coupleColors.gray100}`, boxShadow: '0 1px 4px rgba(0,0,0,0.06)' },
  ...
  codeHint: { margin: 0, fontSize: 12, color: coupleColors.gray400, fontFamily: 'BMHANNAPro, sans-serif' },
  ...
  input: { padding: '14px 16px', fontSize: 16, fontFamily: 'BMJUA, sans-serif', borderRadius: 14, border: `1px solid ${coupleColors.gray200}`, outline: 'none', letterSpacing: 1, backgroundColor: coupleColors.white },
  errorText: { margin: 0, fontSize: 12, color: '#ef4444', fontFamily: 'BMHANNAPro, sans-serif' },
  submitBtn: { padding: '16px', borderRadius: 16, border: 'none', backgroundColor: ACCENT, fontSize: 16, fontWeight: 700, fontFamily: 'BMJUA, sans-serif', color: coupleColors.white, cursor: 'pointer', boxShadow: `0 4px 12px ${ACCENT}55`, marginTop: 8 },
};
