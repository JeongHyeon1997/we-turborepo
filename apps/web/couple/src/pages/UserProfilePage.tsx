...
export function UserProfilePage() {
  ...
  const avatarColor = profile?.avatarColor ?? communityPosts.find(p => p.author.name === decodedName)?.author.avatarColor ?? coupleColors.gray200;
      ...
      <div style={s.profileSection}>
        <div style={s.avatarWrap}>
          <div style={{ ...s.avatarPlaceholder, backgroundColor: avatarColor }}>
            <svg width={48} height={48} viewBox="0 0 24 24" fill={coupleColors.gray500}>
...
const s: Record<string, CSSProperties> = {
  ...
  nickname: {
    fontSize: 20, fontWeight: 700, color: coupleColors.gray900,
  ...
  statNumber: { fontSize: 20, fontWeight: 700, color: coupleColors.gray900, fontFamily: 'BMJUA, sans-serif' },
  ...
  sectionTitle: { fontSize: 14, fontWeight: 700, color: coupleColors.gray800, fontFamily: 'BMJUA, sans-serif' },
  sectionCount: {
    fontSize: 12, padding: '2px 8px', borderRadius: 10,
    backgroundColor: coupleColors.primary100, color: coupleColors.gray600,
    fontFamily: 'BMJUA, sans-serif',
  },
  feed: { display: 'flex', flexDirection: 'column' },
  item: {
    display: 'flex', alignItems: 'flex-start', gap: 12,
    padding: '14px 16px', borderBottom: `1px solid ${coupleColors.gray100}`,
  },
