    ...
    <div style={s.page}>
      <div style={s.form}>
        ...
        <div style={s.avatarWrap}>
          <div style={s.avatar}>
            <svg width={52} height={52} viewBox="0 0 24 24" fill={coupleColors.gray400}>
...
const s: Record<string, CSSProperties> = {
  ...
  input: {
    ...
    border: `1.5px solid ${coupleColors.primary200}`,
    fontSize: 15, fontFamily: 'BMHANNAPro, sans-serif',
    color: coupleColors.gray800, outline: 'none',
    backgroundColor: coupleColors.white,
  },
  hint: {
    fontSize: 11, color: coupleColors.gray400,
    textAlign: 'right', fontFamily: 'BMHANNAPro, sans-serif',
  },
  readOnly: {
    padding: '12px 14px', borderRadius: 12,
    border: `1.5px solid ${coupleColors.gray100}`,
    fontSize: 15, fontFamily: 'BMHANNAPro, sans-serif',
  ...
  saveBtn: {
    ...
    color: coupleColors.white, cursor: 'pointer',
