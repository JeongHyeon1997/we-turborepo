...
export const communityPosts: CommunityPostBase[] = [
  {
    ...
    imageUrls: ['https://picsum.photos/seed/couple1/600/400'],
    category: null,
    likeCount: 42,
    commentCount: 8,
    liked: false,
  ...
  },
  {
    ...
    imageUrls: ['https://picsum.photos/seed/couple3/600/400'],
    category: null,
    likeCount: 67,
    commentCount: 12,
    liked: false,
  ...
  },
  {
    ...
    imageUrls: ['https://picsum.photos/seed/couple5/600/400'],
    category: null,
    likeCount: 89,
    commentCount: 19,
    liked: false,
