...
const s = StyleSheet.create({
  ...
  avatarText: { fontSize: 16, fontFamily: 'BMJUA', color: petColors.gray700 },
  authorInfo: { gap: 2, flex: 1 },
  authorName: { fontSize: 14, fontFamily: 'BMJUA', color: petColors.gray800 },
  ...
  content: {
    ...
    color: petColors.gray700, fontFamily: 'BMHANNAPro',
  },
  ...
  actionCount: { fontSize: 13, color: petColors.gray500, fontFamily: 'BMJUA' },
});
