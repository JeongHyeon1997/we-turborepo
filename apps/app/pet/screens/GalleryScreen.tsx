...
export function GalleryScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: petColors.gray50 }}>
      <FlatList
        data={withImages}
...
const s = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 17, fontFamily: 'BMJUA', color: petColors.gray700 },
  emptyDesc: { fontSize: 13, fontFamily: 'BMHANNAPro', color: petColors.gray400, textAlign: 'center', lineHeight: 22 },
  ...
  photoDate: { fontSize: 12, color: petColors.gray400, fontFamily: 'BMHANNAPro', marginBottom: 2 },
  photoTitle: { fontSize: 16, fontFamily: 'BMJUA', color: petColors.gray800 },
  photoFull: { width: '100%', aspectRatio: 4 / 3 },
  photoBody: { maxHeight: 120, paddingHorizontal: 16, paddingVertical: 12 },
  photoContent: { fontSize: 14, fontFamily: 'BMHANNAPro', color: petColors.gray600, lineHeight: 22 },
});
