...
const s = StyleSheet.create({
  ...
  avatarText: { fontSize: 18, fontFamily: 'BMJUA', color: petColors.gray700 },
  authorInfo: { gap: 2, flex: 1 },
  authorName: { fontSize: 15, fontFamily: 'BMJUA', color: petColors.gray800 },
  date: { fontSize: 12, color: petColors.gray400, fontFamily: 'BMHANNAPro' },
  moreBtn: { padding: 4 },
  moreBtnText: { fontSize: 18, color: petColors.gray400, letterSpacing: 1 },
  content: {
    fontSize: 15, lineHeight: 26,
    color: petColors.gray700, fontFamily: 'BMHANNAPro', marginBottom: 16,
  },
  ...
  actionCount: { fontSize: 14, color: petColors.gray500, fontFamily: 'BMJUA' },
  commentSection: { paddingVertical: 16 },
  commentPlaceholder: {
    textAlign: 'center', color: petColors.gray400,
