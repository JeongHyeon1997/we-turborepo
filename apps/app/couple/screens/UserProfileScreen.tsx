...
const s = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 14, fontFamily: 'BMJUA', color: coupleColors.gray800 },
  sectionBadge: { backgroundColor: coupleColors.primary100, paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  sectionBadgeText: { fontSize: 11, fontFamily: 'BMJUA', color: coupleColors.gray600 },
  item: {
