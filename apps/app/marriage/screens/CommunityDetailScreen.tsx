...
const s = StyleSheet.create({
  ...
  avatarText: { fontSize: 18, fontFamily: 'BMJUA', color: marriageColors.gray700 },
  authorInfo: { gap: 2, flex: 1 },
  authorName: { fontSize: 15, fontFamily: 'BMJUA', color: marriageColors.gray800 },
  ...
  content: {
    ...
    color: marriageColors.gray700, fontFamily: 'BMHANNAPro', marginBottom: 16,
  },
  ...
  actionCount: { fontSize: 14, color: marriageColors.gray500, fontFamily: 'BMJUA' },
  commentSection: { paddingVertical: 16 },
  commentPlaceholder: { textAlign: 'center', color: marriageColors.gray400, fontFamily: 'BMJUA', fontSize: 14 },
});
