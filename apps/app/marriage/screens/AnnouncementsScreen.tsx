...
function AnnouncementItem({ ann, onPress }: { ann: AnnouncementBase; onPress: () => void }) {
  return (
    <Pressable style={s.item} onPress={onPress}>
      ...
      <Ionicons name="chevron-forward" size={16} color={marriageColors.gray400} />
    </Pressable>
  );
}
...
const s = StyleSheet.create({
  ...
  item: {
    ...
    padding: 14, backgroundColor: marriageColors.white,
    borderRadius: 12, borderWidth: 1, borderColor: marriageColors.gray100,
  ...
  badgeText: { fontSize: 10, fontFamily: 'BMJUA', fontWeight: '700' },
  title: { flex: 1, fontSize: 14, fontFamily: 'BMJUA', color: marriageColors.gray800 },
