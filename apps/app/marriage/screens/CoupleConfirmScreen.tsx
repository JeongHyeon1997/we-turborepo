  ...
  return (
    <View style={s.page}>
      <View style={s.card}>
        ...
        <Text style={s.title}>{partner.name}님과 부부이신가요?</Text>
        <Text style={s.sub}>초대 코드로 배우자 연결 요청이 왔어요.</Text>
...
const s = StyleSheet.create({
  page: {
    ...
    padding: 24, backgroundColor: marriageColors.gray50,
  },
  card: {
  ...
  heart: { fontSize: 32 },
  title: { fontSize: 20, fontFamily: 'BMJUA', color: marriageColors.gray900, textAlign: 'center' },
  sub: { fontSize: 13, fontFamily: 'BMHANNAPro', color: marriageColors.gray500, textAlign: 'center', marginTop: -8 },
  partnerInfo: { width: '100%', padding: 12, paddingHorizontal: 16, backgroundColor: marriageColors.primary50, borderRadius: 12 },
  partnerRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  partnerDot: { width: 10, height: 10, borderRadius: 5 },
  partnerName: { fontSize: 14, fontFamily: 'BMJUA', color: marriageColors.gray800 },
  btnRow: { flexDirection: 'row', gap: 10, width: '100%', marginTop: 4 },
  declineBtn: {
    flex: 1, paddingVertical: 14, borderRadius: 14,
    borderWidth: 1, borderColor: marriageColors.gray200, alignItems: 'center',
  },
  declineBtnText: { fontSize: 15, fontFamily: 'BMJUA', color: marriageColors.gray500 },
  acceptBtn: { flex: 2, paddingVertical: 14, borderRadius: 14, backgroundColor: ACCENT, alignItems: 'center' },
  acceptBtnText: { fontSize: 15, fontFamily: 'BMJUA', color: marriageColors.white },
});
